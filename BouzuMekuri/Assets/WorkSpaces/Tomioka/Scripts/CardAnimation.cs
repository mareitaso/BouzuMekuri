...
public class CardAnimation : MonoBehaviour
{
    ...
    public void AnimeYamaToPlayer()
    {
        ...
        {
            //引いたカードのspriteにする
            YamahudaFake.sprite = Resources.Load<Sprite>("Images/MainCards/" + deck.drawcard);
            YamahudaFake.transform.DORotate(new Vector3(0, 0, 0), 0.5f).OnComplete(() =>
            {
                ...
                {
                    //コールバックで移動後の処理
                    test.Player[deck.Count].sprite = Resources.Load<Sprite>("Images/MainCards/" + deck.drawcard);
                    //偽山札を作り移動アニメーションを見せる
